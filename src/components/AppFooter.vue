      ...
      <section class="info-section">
        ...
        <div class="column contact">
          ...
          <div class="social-icons">
            ...
            <q-btn flat round icon="fab fa-linkedin" class="social-btn linkedin" />
          </div>
        </div>
      </section>

      <div class="bg-grey-9 text-center q-pa-sm">
        <div class="text-caption">&copy; 2025 H_FUMBO - Tous droits réservés</div>
      </div>
    </q-footer>
  </template>
